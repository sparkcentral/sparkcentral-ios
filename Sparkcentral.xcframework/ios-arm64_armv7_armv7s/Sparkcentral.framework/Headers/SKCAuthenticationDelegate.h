...
typedef void (^SKCAuthenticationCompletionBlock)(NSString *jwt);
 ...
 */
@protocol SKCAuthenticationDelegate <NSObject>
 ...
 */
- (void)onInvalidToken:(NSError *) error handler:(SKCAuthenticationCompletionBlock)completionHandler;
