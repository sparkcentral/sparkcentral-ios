 ...
 *
 *  @discussion Valid values are SKCMenuItemCamera, SKCMenuItemGallery, SKCMenuItemDocument and SKCMenuItemLocation
 *
 ...
 */
@property(weak, nonatomic, nullable) id<SKCAuthenticationDelegate> authenticationDelegate;
